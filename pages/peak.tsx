...
const description = "";
const elevations = ["13,198n"];
const routes = [
  {
    name: "Route 1. West couloir",
    classRating: "Class 3",
    description:
      "Ascended July 25, 1946, by Fritz Gerstacher and Virginia Whitacre from the Fourth Recess by a couloir that comes down just under the highest pinnacle.",
    slug: "route-1-west-couloir-01d9575a21f8",
  },
  {
    name: "Route 2. East buttress",
    classRating: "",
    description: "Ascended August 1, 1946, by Lester Lavelle and Malcolm Smith",
    slug: "route-2-east-buttress-fe3050614c9e",
  },
  {
    name: "Route 3. West wall and north ridge",
    classRating: "Class 5",
    description:
    ...
    slug: "route-3-west-wall-and-north-ridge-0f340d14868c",
  },
];
        ...
        <main className="p-4 font-sans">
          ...
          <div className="flex flex-row">
            ...
            <div className="pt-2 max-w-prose">
              <p className="font-semibold text-xl">{peakName}</p>
              {elevations.map((e) => (
              ...
              {routes.map((r) => (
                <div key={r.slug} className="">
                  ...
                  <p className="border-b border-slate-400 mb-3 pb-3">
                    {r.description}
                  </p>
                </div>
              ))}
            ...
            <div className="hidden md:inline pt-2 border-slate-400 border-l pl-2 ml-2 mt-2">
              <p>
                Maybe some sort of headr/table here with elevation, prominence,
                first ascents, coordinates, loj/pb links, caltopo
              </p>
            </div>
          </div>
        </main>
